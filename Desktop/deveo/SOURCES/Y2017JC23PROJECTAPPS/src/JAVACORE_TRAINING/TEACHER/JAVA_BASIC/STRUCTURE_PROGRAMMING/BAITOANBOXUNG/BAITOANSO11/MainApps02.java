...
public class MainApps02 {
	public static void main(String[] args) {
		...
		boolean isResult = KiemTraCoPhaiTamGiac(
														dCanh01, dCanh02, dCanh03);
		if(isResult)
			System.out.println("- Đây là các cạnh của Tam giác nhé :D");
		else
			System.out.println("- Đây ko phải là Tam giác!");
	}
	
	private static boolean KiemTraCoPhaiTamGiac(
														double dCanh01,
															double dCanh02,
																double dCanh03){
		return ((dCanh01 + dCanh02) > dCanh03 &&
							  (dCanh02 + dCanh03) > dCanh01 &&
						         (dCanh03 + dCanh01) > dCanh02) ? true : false;
	}
}
